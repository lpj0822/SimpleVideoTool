...
#include "save_data/myvideowriter.h"
...
public:
    ...
    int initSaveCroppingVideoData(const QString &fileNameDir,std::shared_ptr<VideoProcess> video,double scale=1.0,bool isAll=true,int startPos=0,int stopPos=0);
